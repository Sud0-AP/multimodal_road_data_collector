...
// in multimodal_road_data_collector/test/features/calibration/presentation/state/calibration_notifier_test.dart.
...
class MockCalibrationRepository extends _i1.Mock
    implements _i2.CalibrationRepository {
  ...
  _i3.Future<bool> saveInitialCalibrationData(
    _i4.InitialCalibrationData? data,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i3.Future<_i4.InitialCalibrationData?> loadInitialCalibrationData() =>
      (super.noSuchMethod(
            Invocation.method(#loadInitialCalibrationData, []),
            returnValue: _i3.Future<_i4.InitialCalibrationData?>.value(),
          )
          as _i3.Future<_i4.InitialCalibrationData?>);
...
///
/// See the documentation for Mockito's code generation for more information.
class MockSensorService extends _i1.Mock implements _i5.SensorService {
  MockSensorService() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i3.Stream<_i5.SensorData> getSensorDataStream() =>
      (super.noSuchMethod(
            Invocation.method(#getSensorDataStream, []),
            returnValue: _i3.Stream<_i5.SensorData>.empty(),
          )
          as _i3.Stream<_i5.SensorData>);
